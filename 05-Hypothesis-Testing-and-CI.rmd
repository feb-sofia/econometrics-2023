...
score of the children in the `kids` dataset depending on the educational
...
3.  Make a decision to reject $H_0$ if the t-statistic is less than -2.
...
3.  In how many cases would you make a wrong decision if you reject
    $H_0$ for values of the t-statistic les than -2?
