...
For discrite random variable $X$ with possible values $x_1, x_2,\ldots,x_n$ the weighted average of the possible outcomes: \begin{align}
...
For two independent random variables $X$ and $Y$. \begin{align}
  Var(X + Y) = Var(X) + Var(Y)
\end{align}
