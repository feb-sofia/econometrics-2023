...
:::
:::{.poof}
Take the expression for the sum of cross-products from @them-covar-decomp and set $y_i$ = $x_i$:
...
The residuals in the linear model sum to zero if the model includes a constant.
